...
// The main drwback of TS is we cant use it directly in browsers or Node.js
// we need to transpile it to JS first using the TypeScript compiler (tsc)

// Example:

// Step 1: Install TypeScript globally using npm
// Command: npm install -g typescript

// Step 2: Create a TypeScript file (example.ts)
let greeting: string = "Hello, TypeScript!";
console.log(greeting);

// Step 3: Transpile the TypeScript file to JavaScript
// Command: tsc example.ts

// Step 4: Run the compiled JavaScript file using Node.js
